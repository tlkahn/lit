...
mod tests {
    ...
    #[test]
    fn from_id_returns_none_for_removed_trash_ids() {
        assert!(ContextMenuAction::from_id("ctx_trash_restore").is_none());
        assert!(ContextMenuAction::from_id("ctx_trash_purge").is_none());
    }
