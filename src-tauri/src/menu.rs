...
mod tests {
    ...
    #[test]
    fn cardbox_html_export_menu_id_defined() {
        assert_eq!(MENU_ID_EXPORT_CARDBOX_HTML, "export_cardbox_html");
    }

    #[test]
    fn cardbox_html_export_event_constant_defined() {
        assert_eq!(EVENT_EXPORT_CARDBOX_HTML, "menu://export-cardbox-html");
    }

    #[test]
    fn cardbox_html_export_from_id() {
